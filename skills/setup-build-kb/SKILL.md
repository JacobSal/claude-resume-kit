...
2. **Resolve every path under the root.** Every relative path named in this skill — `config.md`, `kit_state.md`, `resume_builder/...`, `knowledge_base/...`, `output/...`, `JDs/...` — resolves under RESUME_KIT_ROOT. Example: `resume_builder/experience/...` -> `<RESUME_KIT_ROOT>/resume_builder/experience/...`.
...
1. Read `kit_state.md` — check KB Corrections Log
